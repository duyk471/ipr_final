...
const PropertiesPanel = ({ canvasRef }) => {
    ...
    if (!selectedObject) {
        return (
            <div className="flex flex-col h-full bg-white dark:bg-[#1E293B] p-6 gap-6 transition-colors overflow-y-auto custom-scrollbar">
                <h3 className="font-bold text-slate-800 dark:text-slate-200 border-b border-slate-200/60 dark:border-slate-700/60 pb-2 uppercase text-[10px] tracking-widest flex items-center gap-2">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Dimensions</label>
                        <div className="px-3 py-2 text-[13px] border border-slate-200/60 dark:border-slate-700/60 rounded-xl bg-slate-50/50 dark:bg-[#0B1120]/50 text-slate-700 dark:text-slate-300 font-mono">
                    ...
                    {/* Background Color */}
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Background Color</label>
                        <div className="flex items-center gap-3">
                            <input
                                type="color"
                                value={backgroundColor}
                                onChange={(e) => handleBackgroundColorChange(e.target.value)}
                                className="w-10 h-10 rounded-lg border border-slate-200/60 dark:border-slate-700/60 p-0.5 cursor-pointer overflow-hidden bg-white dark:bg-[#1E293B]"
                            />
                            <input
                                type="text"
                                value={backgroundColor}
                                onChange={(e) => handleBackgroundColorChange(e.target.value)}
                                className="flex-1 px-3 py-2 text-[13px] border border-slate-200/60 dark:border-slate-700/60 rounded-xl bg-slate-50/50 dark:bg-[#0B1120]/50 focus:bg-white dark:focus:bg-[#1E293B] focus:border-slate-400 focus:ring-4 focus:ring-slate-600/10 outline-none transition-all duration-200 text-slate-700 dark:text-slate-300 font-mono"
                            />
                        </div>
                    </div>
                </div>

                <div className="flex-1 flex flex-col items-center justify-center text-center text-slate-400 text-[11px] border-t border-slate-200/60 dark:border-slate-700/60 pt-6">
    ...
    return (
        <div className="flex flex-col h-full bg-transparent p-5 gap-6 transition-colors overflow-y-auto overflow-x-hidden custom-scrollbar">
            <h3 className="font-bold text-slate-800 dark:text-slate-200 border-b border-slate-200/60 dark:border-slate-700/60 pb-2 uppercase text-[10px] tracking-widest flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-slate-600"></span>
            ...
            {/* Color / Fill */}
            <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Fill Color</label>
                <div className="flex items-center gap-3">
                    <input
                        type="color"
            ...
            <div className="flex flex-col gap-2">
                <label className="text-xs font-semibold text-slate-500 uppercase">Opacity ({Math.round((selectedObject.opacity || 1) * 100)}%)</label>
                <input
                    type="range"
                    min="0"
                    max="1"
            ...
            <div className="flex flex-col gap-3 pt-4 border-t">
                <label className="text-xs font-semibold text-slate-500 uppercase">Position & Size</label>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            ...
                            className="px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-slate-600 focus:outline-none font-mono"
                        />
                    </div>
                    <div className="flex flex-col gap-1">
            ...
            {isText && (
                <>
                    <div className="flex flex-col gap-2 pt-4 border-t">
                        <label className="text-xs font-semibold text-slate-500 uppercase">Typography</label>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <select
                                ...
                                className="px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-slate-600 focus:outline-none bg-white"
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-xs font-semibold text-slate-500 uppercase mt-2">Text Properties</label>
                        <div className="flex justify-between items-center gap-2">
                            <label className="text-xs text-slate-400 flex-1">Size</label>
                            <input
                                type="number"
                                min="1"
                                value={selectedObject.fontSize || 12}
                                onChange={(e) => handleChange('fontSize', Math.max(1, parseInt(e.target.value) || 1))}
                                className="px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-slate-600 focus:outline-none w-20"
                            />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2 pt-2">
                        <label className="text-xs font-semibold text-slate-500 uppercase">Style</label>
                        <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 p-1 rounded-lg w-max text-sm">
                            <button
                                onClick={() => handleChange('fontWeight', selectedObject.fontWeight === 'bold' ? 'normal' : 'bold')}
                                className={`w-8 h-8 rounded flex items-center justify-center font-bold transition-colors ${selectedObject.fontWeight === 'bold' ? 'bg-white shadow text-slate-800' : 'text-slate-600 hover:bg-slate-200'}`}
                                title="Bold"
                            >
                                B
                            </button>
                            <button
                                ...
                                className={`w-8 h-8 rounded flex items-center justify-center font-serif italic transition-colors ${selectedObject.fontStyle === 'italic' ? 'bg-white shadow text-slate-800' : 'text-slate-600 hover:bg-slate-200'}`}
                                title="Italic"
                            >
                                I
                            </button>
                            <button
                                ...
                                className={`w-8 h-8 rounded flex items-center justify-center underline transition-colors ${selectedObject.underline ? 'bg-white shadow text-slate-800' : 'text-slate-600 hover:bg-slate-200'}`}
                                title="Underline"
                            >
                                U
                            </button>
                    ...
                    <div className="flex flex-col gap-2 pt-2">
                        ...
                        <textarea
                            ...
                            className="px-3 py-2 text-sm border rounded-lg h-24 resize-none focus:ring-2 focus:ring-slate-600 focus:outline-none"
                        />
                    </div>

                    {/* Text Effects */}
                    <div className="flex flex-col gap-2 pt-4 border-t">
                        <label className="text-xs font-semibold text-slate-500 uppercase">Text Effects</label>
                        <div className="grid grid-cols-2 gap-2">
                            <button
                                onClick={() => canvasRef.current?.applyTextEffect('none')}
                                className="px-2 py-1.5 bg-slate-50 hover:bg-slate-100 border text-slate-600 rounded-lg text-xs font-medium"
                            >None</button>
                            <button
                                onClick={() => canvasRef.current?.applyTextEffect('shadow')}
                                className="px-2 py-1.5 bg-slate-50 hover:bg-slate-100 border text-slate-600 rounded-lg text-xs font-medium drop-shadow-md"
                            >Shadow</button>
                            <button
                            ...
                            <button
                                ...
                                className="px-2 py-1.5 bg-slate-50 hover:bg-slate-100 border text-slate-800 rounded-lg text-xs font-black"
                                style={{ WebkitTextStroke: "1px black", color: "white" }}
                            >Outline</button>
                            <button
                                onClick={() => canvasRef.current?.applyTextEffect('hollow')}
                                className="px-2 py-1.5 bg-slate-50 hover:bg-slate-100 border text-slate-800 rounded-lg text-xs font-bold col-span-2"
                    ...
                    <div className="flex flex-col gap-2 pt-4 border-t">
                        <div className="flex justify-between items-center">
                            <label className="text-xs font-semibold text-slate-500 uppercase">Curved Text</label>
                            <label className="flex items-center cursor-pointer">
                                <div className="relative">
                                    ...
                                    />
                                    <div className={`block w-8 h-4 rounded-full transition-colors ${selectedObject.isCurved ? 'bg-slate-600' : 'bg-slate-300'}`}></div>
                        ...
                        {selectedObject.isCurved && (
                            <div className="flex flex-col gap-1 mt-1">
                                <div className="flex justify-between">
                                    <label className="text-[10px] text-slate-400">Curve Radius</label>
                                    <span className="text-[10px] text-slate-400 font-mono">{selectedObject.curveRadius || 50}</span>
                                </div>
                                <input
                                    type="range"
                                    min="-150"
            ...
            {isImage && (
                <div className="flex flex-col gap-3 pt-4 border-t dark:border-slate-700">
                    ...
                    <button
                        ...
                        disabled={removingBg}
                        className="w-full py-2.5 bg-gradient-to-r from-purple-500 to-slate-800 hover:from-purple-600 hover:to-slate-900 text-white rounded-xl text-sm font-semibold transition-all disabled:opacity-50 shadow-md flex items-center justify-center gap-2"
                    >
                        {removingBg ? (
                            <>
                ...
                <div className="flex flex-col gap-3 pt-4 border-t">
                    <label className="text-xs font-semibold text-slate-500 uppercase flex items-center justify-between">
                        ...
                        <button 
                            ...
                            className="text-[10px] text-slate-600 hover:text-slate-900 font-normal normal-case"
                        >
                            Reset
                        </button>
                    </label>
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between">
                            ...
                            <span className="text-[10px] text-slate-400 font-mono">{selectedObject.filters?.brightness?.toFixed(2) || '0.00'}</span>
                        </div>
                        <input
                            type="range"
                            min="-1"
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between">
                            ...
                            <span className="text-[10px] text-slate-400 font-mono">{selectedObject.filters?.contrast?.toFixed(2) || '0.00'}</span>
                        </div>
                        <input
                            type="range"
                            min="-1"
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between">
                            <label className="text-xs text-slate-400">Hue Rotation</label>
                            <span className="text-[10px] text-slate-400 font-mono">{selectedObject.filters?.hue?.toFixed(2) || '0.00'}</span>
                        </div>
                        <input
                            type="range"
                            min="-2"
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between">
                            ...
                            <span className="text-[10px] text-slate-400 font-mono">{selectedObject.filters?.blur?.toFixed(2) || '0.00'}</span>
                        </div>
                        <input
                            type="range"
                            min="0"
            ...
            {/* Layer Control */}
            <div className="flex flex-col gap-2 pt-4 border-t">
                <label className="text-xs font-semibold text-slate-500 uppercase">Layer Order</label>
                <div className="grid grid-cols-2 gap-2">
                    <button
                ...
                <label className="text-xs font-semibold text-slate-500 uppercase mt-2">Actions</label>
                <div className="grid grid-cols-2 gap-2">
                    <button
                    ...
                    {selectedObject.isActiveSelection && (
                        <button
                            ...
                            className="px-3 py-2 bg-slate-100 text-slate-800 hover:bg-slate-200 rounded-lg text-xs font-medium transition-colors col-span-2"
                        >
